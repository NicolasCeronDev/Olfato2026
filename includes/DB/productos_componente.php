...
function mostrarProductos($categoria = 'todos', $limite = 6)
{
    global $conexion;

    // Construir la consulta según la categoría
    ...
    if ($categoria !== 'todos') {
        $sql .= " WHERE g.nombre_genero_perfume = ?";
    }
    ...
    <div class="modal-contenido">
        ...
        <div class="modal-info">
            ...
            <div class="modal-opciones">
                ...
                <!-- El contenedor de colores se creará dinámicamente con JavaScript -->
